...
// GetTagList provides a mock function with given fields: u, r
func (_m *Remote) GetTagList(u *model.User, r *model.Repo) (model.TagList, error) {
	ret := _m.Called(u, r)

	var r0 model.TagList
	if rf, ok := ret.Get(0).(func(*model.User, *model.Repo) model.TagList); ok {
		r0 = rf(u, r)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(model.TagList)
		}
	}
...
// Tag provides a mock function with given fields: u, r, _a2, sha
func (_m *Remote) Tag(u *model.User, r *model.Repo, _a2 *version.Version, sha *string) error {
	ret := _m.Called(u, r, _a2, sha)
